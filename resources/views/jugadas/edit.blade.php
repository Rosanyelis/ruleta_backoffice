    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal" method="POST" action="{{ url('/plantilla-de-jugadas/configurar-jugadas/'.$jugadas->id.'/actualizar-jugada') }}" >
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <div class="col">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ $jugadas->nombre }}" placeholder="Ejemplo: Pleno">
