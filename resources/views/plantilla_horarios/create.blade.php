    ...
    <div class="container-fluid">
        <div class="row page-title">
            <div class="col-md-12">
                ...
                <h4 class="mb-1 mt-0">Crear Plantilla de Horarios</h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal" method="POST" action="{{ url('/plantilla-de-horarios/guardar-plantilla-de-horarios') }}">
                            @csrf
                            <div class="row">
                                <div class="col">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre') }}" placeholder="Ejemplo: Plantilla de Horarios de Ruleta">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            {!! Form::select('hora[]', $data['horas'], old('hora[]'), 
                                                $errors->has('hora') ?
