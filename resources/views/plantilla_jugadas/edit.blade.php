    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal" method="POST" action="{{ url('/plantilla-de-jugadas/'.$plantilla->id.'/actualizar-plantilla-de-jugadas') }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            {!! Form::select('jugada[]', $data['jugadas'], $data['plantilla_jugada_jugada'], 
                                                $errors->has('jugada') ?
