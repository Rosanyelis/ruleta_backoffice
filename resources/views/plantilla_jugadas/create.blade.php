    ...
    <div class="container-fluid">
        <div class="row page-title">
            <div class="col-md-12">
                ...
                <h4 class="mb-1 mt-0">Crear Plantilla de Jugadas</h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal" method="POST" action="{{ url('/plantilla-de-jugadas/guardar-plantilla-de-jugadas') }}">
                            @csrf
                            <div class="row">
                                <div class="col">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre') }}" placeholder="Ejemplo: Plantilla de Jugadas de Ruleta">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label 
                                            @error('jugada') text-danger @enderror">
                                            Jugadas
                                        </label>
                                        <div class="col-lg-9">
                                            {!! Form::select('jugada[]', $data['jugadas'], old('jugada[]'), 
                                                $errors->has('jugada') ?
                                                    ['id' => 'jugada', 'class' => 'form-control wide is-invalid', 'data-plugin' => 'customselect', 'multiple'=>'multiple']:
                                                    ['id' => 'jugada', 'class' => 'form-control wide', 'data-plugin' => 'customselect', 'multiple'=>'multiple']) !!}
                                            @if ($errors->has('jugada'))
                                                <small class="form-text text-danger">{{ $errors->first('jugada') }}</small>
                                            @endif
                                        </div>
                                    </div>
                                </div>
