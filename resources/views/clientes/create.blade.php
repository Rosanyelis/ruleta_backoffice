    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal" method="POST" action="{{ url('/clientes/guardar-cliente') }}">
                            @csrf
                            <div class="row">
                                <div class="col">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <select name="responsable_id" class="form-control @error('responsable_id') is-invalid @enderror">
                                                ...
                                                <option value="{{ $resp->id }}" {{ old('responsable_id') ==  $resp->id ? 'selected' : '' }}>{{ $resp->rif }} - {{ $resp->nombre }} {{ $resp->apellido }}</option>
                                                @endforeach
                                            </select>
