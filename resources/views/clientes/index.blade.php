    ...
    <div class="container-fluid">
        <div class="row page-title">
            <div class="col-md-12">
                ...
                <h4 class="mb-1 mt-0">Listado de Clientes</h4>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-right mb-4">
                            <a href="{{ url('/clientes/nuevo-cliente') }}" class="btn btn-secondary"><i class="uil uil-plus"></i> Nuevo Cliente</a>
                        </div>
                        <table id="basic-datatable" class="table dt-responsive nowrap">
                            ...
                            <tbody>
                                ...
                                <div class="modal fade" id="modal-error{{ $cli->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-errorLabel" aria-hidden="true">
