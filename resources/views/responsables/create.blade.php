    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal" method="POST" action="{{ url('/responsables/guardar-responsable') }}">
                            @csrf
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="rif" class="form-control @error('rif') is-invalid @enderror" value="{{ old('rif') }}" placeholder="Ejemplo: V123456789 / J123456789">
                                            @if ($errors->has('rif'))
