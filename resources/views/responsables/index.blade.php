                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-right mb-4">
                            <a href="{{ url('/responsables/nuevo-responsable') }}" class="btn btn-secondary btn-rounded"><i class="uil uil-plus pt-4"></i> Nuevo Responsable</a>
                        </div>
                        <table id="basic-datatable" class="table dt-responsive nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $resp->rif }}</td>
                                    <td>
                                        <a href="{{ url('/responsables/'.$resp->id.'/editar-responsable') }}"><i class="uil uil-edit-alt"></i></a>
