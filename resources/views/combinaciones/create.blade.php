            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb" class="float-right mt-1">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Nueva Combinación</li>
                    </ol>
                </nav>
                <h4 class="mb-1 mt-0">Nueva Combinación</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('/combinaciones/guardar-combinacion') }}">
                            @csrf
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="pago" class="form-control @error('pago') is-invalid @enderror" value="{{ old('pago') }}">
                                            @if ($errors->has('pago'))
