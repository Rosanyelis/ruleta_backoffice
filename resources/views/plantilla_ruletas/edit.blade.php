    ...
    <div class="container-fluid">
            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb" class="float-right mt-1">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Editar Plantilla de Ruleta</li>
                    </ol>
                </nav>
                <h4 class="mb-1 mt-0">Editar Plantilla de Ruleta</h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal" method="POST" action="{{ url('/plantilla-de-ruletas/'.$plantilla->id.'/actualizar-plantilla-de-ruletas') }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ $plantilla->nombre }}" placeholder="Ejemplo: Plantilla de Juegos de Casino">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            {!! Form::select('ruleta[]', $data['ruletas'], $data['plantilla_ruleta_ruleta'], 
                                                $errors->has('ruleta') ?
