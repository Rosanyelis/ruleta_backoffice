    ...
    <div class="container-fluid">
            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb" class="float-right mt-1">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Crear Plantilla de Ruleta</li>
                    </ol>
                </nav>
                <h4 class="mb-1 mt-0">Crear Plantilla de Ruleta</h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal" method="POST" action="{{ url('/plantilla-de-ruletas/guardar-plantilla-de-ruletas') }}">
                            @csrf
                            <div class="row">
                                <div class="col">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre') }}" placeholder="Ejemplo: Plantilla de Juegos de Casino">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            {!! Form::select('ruleta[]', $data['ruletas'], old('ruleta[]'), 
                                                $errors->has('ruleta') ?
                                                    ['id' => 'ruleta', 'class' => 'form-control wide is-invalid', 'data-plugin' => 'customselect', 'multiple'=>'multiple']:
                                                    ['id' => 'ruleta', 'class' => 'form-control wide', 'data-plugin' => 'customselect', 'multiple'=>'multiple']) !!}
                                            @if ($errors->has('ruleta'))
                                                <small class="form-text text-danger">{{ $errors->first('ruleta') }}</small>
                                            @endif
                                        </div>
                                    </div>
                                </div>
